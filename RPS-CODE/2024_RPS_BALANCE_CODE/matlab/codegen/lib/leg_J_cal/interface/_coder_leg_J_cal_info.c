...
/* Include Files */
#include "_coder_leg_J_cal_info.h"
#include "emlrt.h"
#include "tmwtypes.h"
...
mxArray *emlrtMexFcnProperties(void)
{
  ...
  emlrtSetField(xEntryPoints, 0, "Name", emlrtMxCreateString("leg_J_cal"));
  ...
  emlrtSetField(
      ...
      emlrtMxCreateString(
          ...
          "\xa8\\foc-wheel-legged-robot-master\\matlab\\leg_J_cal.m"));
  emlrtSetField(xEntryPoints, 0, "TimeStamp",
                emlrtMxCreateDoubleScalar(739275.85788194439));
...
/*
 * File trailer for _coder_leg_J_cal_info.c
 *
 * [EOF]
 */
