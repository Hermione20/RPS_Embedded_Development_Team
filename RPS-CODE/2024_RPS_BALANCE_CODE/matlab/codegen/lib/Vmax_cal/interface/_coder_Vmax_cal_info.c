...
/* Include Files */
#include "_coder_Vmax_cal_info.h"
#include "emlrt.h"
#include "tmwtypes.h"
...
mxArray *emlrtMexFcnProperties(void)
{
  ...
  emlrtSetField(xEntryPoints, 0, "Name", emlrtMxCreateString("Vmax_cal"));
  ...
  emlrtSetField(
      ...
      emlrtMxCreateString(
          ...
          "\xa8\\foc-wheel-legged-robot-master\\matlab\\Vmax_cal.m"));
  emlrtSetField(xEntryPoints, 0, "TimeStamp",
                emlrtMxCreateDoubleScalar(739251.06769675924));
...
/*
 * File trailer for _coder_Vmax_cal_info.c
 *
 * [EOF]
 */
