...
{
	  if (gim.ctrl_mode == GIMBAL_INIT || gim.ctrl_mode == GIMBAL_AUTO_SMALL_BUFF || gim.ctrl_mode == GIMBAL_POSITION_MODE || gim.ctrl_mode == GIMBAL_AUTO_BIG_BUFF ||gim.ctrl_mode == GIMBAL_AUTO_ANGLE || GetInputMode() == STOP)
	  {
