...
//      client_custom_sight_bead.grapic_data_struct[1].color=UI_YELLOW;
		...
		case 24:                          
    {
      ...
      client_custom_motor_error.grapic_data_struct.operate_type=1;  //1 增加 2修改图形 3删除单个图形 5删除一个图层的图形 6删除所有图形
      client_custom_motor_error.grapic_data_struct.layer=1;   //图层
      client_custom_motor_error.grapic_data_struct.graphic_type=7;  //0 直线 1矩形 2整圆 3椭圆 4圆弧 5浮点数 6整数型 7字符
