...
//#define setSmallBuffSignIdentifyIO()     GPIO_SetBits(GPIOC, GPIO_Pin_5)
//#define resetSmallBuffSignIdentifyIO()   GPIO_ResetBits(GPIOC, GPIO_Pin_5)
//#define setBigBuffBuffSignIdentifyIO()   GPIO_SetBits(GPIOA, GPIO_Pin_7)
//#define resetBigBuffSignIdentifyIO()     GPIO_ResetBits(GPIOA, GPIO_Pin_7)
#endif
