...
//标识3号步兵
#if STANDARD == 3
#define OpenDoor PWM4=75,PWM5=150;//4-left    40  200    //73 180   195  88    90 32
#define CloseDoor  PWM4=150,PWM5=75;
#elif STANDARD ==4
////标识四号步兵
////标识四号步兵
...
#elif STANDARD ==5
////标识四号步兵
#define CloseDoor PWM4=174,PWM5=76    //76;//80  4-left    40  200    170
#define OpenDoor  PWM4=95,PWM5=150;
