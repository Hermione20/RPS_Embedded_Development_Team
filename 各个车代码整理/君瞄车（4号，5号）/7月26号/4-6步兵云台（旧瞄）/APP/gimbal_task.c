...
//----------------小陀螺P轴陀螺仪------------------------
    ...
    //------------------------------------------------
     PID_struct_init(&pid_yaw, POSITION_PID, 500, 10,
		                18,0.1f,5);//15, 0.1f, 25); //10.0f, 0, 100  13
     PID_struct_init(&pid_yaw_speed, POSITION_PID, 29000, 10000,
                    200,0.1f,80);//250,0,10);//250.0f,6.0f, 50-->300.0f,5.0f, 70
#elif STANDARD == 5
////标识5号码步兵
//----------------小陀螺P轴陀螺仪------------------------
    PID_struct_init(&pid_pit, POSITION_PID, 500,100,
                     30,0.1f,5); //15,0.01f,8); //8.0f, ,40    15,0.003f,5   18    16  5    //25 0.01 20
    PID_struct_init(&pid_pit_speed, POSITION_PID, 27000, 2000,
                    300,0.1f,5); //200, 0.3f, 18);//   170, 0.001f, 60--160 8 0    ->  180 10 50  ->190 12 70  ->120 8 0-》180.0f, 10.0f, 30 -> 235, 0.002f, 45
										//15 0.01 0...120 0 0       180 0.2 20    
    //------------------------------------------------
...
#elif STANDARD == 4
//  PID_struct_init(&pid_pit_follow, POSITION_PID, 500, 100, 9, 0.001f, 60.0f);  //
...
//                  50.0f,0.01f, 10);//I太大时，陀螺开启云台抖动严重
	    ...
	    PID_struct_init(&pid_pit_follow, POSITION_PID, 500,100,
                     25,0.1f,5); //15,0.01f,8); //8.0f, ,40    15,0.003f,5   18    16  5    //25 0.01 20
    PID_struct_init(&pid_pit_speed_follow, POSITION_PID, 27000, 2000,
                    180,0.1f,5); //200, 0.3f, 18);//   170, 0.001f, 60--160 8 0    ->  180 10 50  ->190 12 70  ->120 8 0-》180.0f, 10.0f, 30 -> 235, 0.002f, 45
										//15 0.01 0...120 0 0       180 0.2 20    
    //------------------------------------------------
     PID_struct_init(&pid_yaw_follow, POSITION_PID, 500, 10,
		                18,0.1f,5);//15, 0.1f, 25); //10.0f, 0, 100  13
     PID_struct_init(&pid_yaw_speed_follow, POSITION_PID, 29000, 10000,
                    200,0.1f,80);//250,0,10);//250.0f,6.0f, 50-->300.0f,5.0f, 70
