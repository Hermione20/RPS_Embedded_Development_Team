...
/********************速度角度双环*************************/
			...
			/*****************************延迟优化****************************/		
//			if(last_single_shoot_count!=single_shoot_count)
//			{	
//				shoot_delay_time=0;
//				shoot_delay_time++;
//			}
//			if(last_bullet_speed!=judge_rece_mesg.shoot_data.bullet_speed)
//			{
//				shoot_delay_time=0;
//			}
//			if(shoot_delay_time>=50)
//			{
//				pid_trigger_angle_buf.set-=5;
//				shoot_delay_time=0;
//			}
			/******************************************************************/
...
//		last_single_shoot_count=single_shoot_count;
		}
	}
...
void shot_param_init(void)
{
  PID_struct_init(&pid_trigger_angle, POSITION_PID, 5000, 1000,5,0.2,15);
	PID_struct_init(&pid_trigger_speed,POSITION_PID,25000,5000,300,0.1,4);
