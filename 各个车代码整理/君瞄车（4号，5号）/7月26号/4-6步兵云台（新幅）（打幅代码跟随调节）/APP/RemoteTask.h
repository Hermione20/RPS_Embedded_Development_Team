...
//#define STICK_TO_CHASSIS_SPEED_REF_FACT     0.70f
...
#define MOUSE_TO_YAW_ANGLE_INC_FACT 		0.06f//3.16 修改提高 0.03
#elif STANDARD == 4
#define MOUSE_TO_PITCH_ANGLE_INC_FACT 		0.04f
#define MOUSE_TO_YAW_ANGLE_INC_FACT 		0.06f//3.16 修改提高 0.03
#elif STANDARD == 5
#define MOUSE_TO_PITCH_ANGLE_INC_FACT 		0.048f
#define MOUSE_TO_YAW_ANGLE_INC_FACT 		0.06f//3.16 修改提高 0.03
#elif STANDARD == 6
#define MOUSE_TO_PITCH_ANGLE_INC_FACT 		0.04f
#define MOUSE_TO_YAW_ANGLE_INC_FACT 		0.06f//3.16 修改提高 0.03
...
extern int16_t most_power_Flagg;
extern u8 key_B_flag;
