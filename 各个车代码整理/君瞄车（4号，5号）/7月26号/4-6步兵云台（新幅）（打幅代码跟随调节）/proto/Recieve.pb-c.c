...
static const ProtobufCFieldDescriptor device_to_host__frame__field_descriptors[17] =
{
  {
    "Current_Pitch_",
    1,
  ...
  },
  {
    ...
    PROTOBUF_C_TYPE_INT32,
    0,   /* quantifier_offset */
    offsetof(DeviceToHost__Frame, reset_tracker),
    NULL,
    NULL,
    0,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
  },
  {
    ...
    PROTOBUF_C_TYPE_FLOAT,
    0,   /* quantifier_offset */
    offsetof(DeviceToHost__Frame, pitch_speed_),
    NULL,
    NULL,
    0,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
  },
  {
    ...
    PROTOBUF_C_TYPE_FLOAT,
    0,   /* quantifier_offset */
    offsetof(DeviceToHost__Frame, yaw_speed_),
    NULL,
    NULL,
    0,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
...
static const unsigned device_to_host__frame__field_indices_by_name[] = {
  ...
  5,   /* field[5] = Mode_ */
  15,   /* field[15] = Pitch_Speed_ */
  14,   /* field[14] = Reset_Tracker */
  16,   /* field[16] = Yaw_Speed_ */
};
