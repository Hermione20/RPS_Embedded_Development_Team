...
//				}break;
        case 0x610:
				{
        capacitance_message3.mode=(msg->Data[0]<<8)|msg->Data[1];
				capacitance_message3.mode_sure=(msg->Data[2]<<8)|msg->Data[3];
				}break; 
				case 0x611:
				{
         capacitance_message3.in_power=(msg->Data[0]<<8)|msg->Data[1];
				capacitance_message3.in_v=(msg->Data[2]<<8)|msg->Data[3];
					capacitance_message3.in_i=(msg->Data[4]<<8)|msg->Data[5];
				}break; 
				case 0x612:
				{
         capacitance_message3.out_power=(msg->Data[0]<<8)|msg->Data[1];
				capacitance_message3.out_v=(msg->Data[2]<<8)|msg->Data[3];
					capacitance_message3.out_i=(msg->Data[4]<<8)|msg->Data[5];
				}break; 
				case 0x613:
				{
        capacitance_message3.tempureture=(msg->Data[0]<<8)|msg->Data[1];
				capacitance_message3.time=(msg->Data[2]<<8)|msg->Data[3];
        capacitance_message3.this_time=(msg->Data[4]<<8)|msg->Data[5];
				}break; 
...
{   CanTxMsg tx_message;
    ...
    tx_message.Data[3] = 0;
	  tx_message.Data[4] = 0>> 8;
    tx_message.Data[5] = 0;
    tx_message.Data[6] = 0>>8;
    tx_message.Data[7] = 0;
