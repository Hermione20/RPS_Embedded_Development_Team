...
// <4=> NUM_4
// <5=> NUM_5
#define STANDARD 			5 //选择步兵为3号 或者4号
...
//标识3号码步兵
//pitch轴电机初始位置
#define  GMPitchEncoder_Offset 600
//yaw轴电机初始位置
#define GMYawEncoder_Offset   4800//4053
//陀螺仪X轴默认校准值
...
////标识5号码步兵
////标识5号码步兵
#define  GMPitchEncoder_Offset 6120
//yaw轴电机初始位置
#define  GMYawEncoder_Offset   1385
#define GYRO_REAL_X_OFFSET 0.00559780467
#define GYRO_REAL_Y_OFFSET -0.0156064359
#define GYRO_REAL_Z_OFFSET -0.0091483118
...
//靶面长mm
#define TARGET_SURFACE_LENGTH      4.7e-3F
//靶面宽mm
#define TARGET_SURFACE_WIDTH        4.7e-3F
